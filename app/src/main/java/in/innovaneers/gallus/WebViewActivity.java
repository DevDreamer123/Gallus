...
import in.innovaneers.gallus.model.ASAUtility;
import in.innovaneers.gallus.model.AvenuesParams;
import in.innovaneers.gallus.model.Constants;
import in.innovaneers.gallus.model.LoadingDialog;
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            if (!ServiceUtility.chkNull(vResponse).equals("")
                ...
                encVal = ASAUtility.encrypt(vEncVal.substring(0, vEncVal.length() - 1), vResponse);  //encrypt amount and currency
            }
